...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-static --disable-network --disable-debug --enable-shared --enable-avresample
prefix=/usr/local
...
CC_IDENT=gcc 6.2.0 (Rev2, Built by MSYS2 project)
ARCH=x86
INTRINSICS=none
CC=gcc
CXX=g++
...
EXTRALIBS=-lavicap32 -lgdi32 -lpsapi -lole32 -lstrmiids -luuid -loleaut32 -lshlwapi  -liconv -lsecur32 -lm -lbz2 -lz -lpsapi -ladvapi32 -lshell32 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
