...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-static --disable-network --disable-debug --enable-shared --enable-gpl --enable-libx264 --extra-cflags='-IC:/MinGW/msys/1.0/home/rlustig/x264-snapshot-20140520-2245' --extra-ldflags=-L/usr/local/lib
prefix=/usr/local
...
LD_PATH=-L
DLLTOOL=dlltool
LDFLAGS= -L/usr/local/lib  -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
...
EXTRALIBS=-lavicap32 -lpsapi -lole32 -lstrmiids -luuid -lx264 -lm -lpsapi -ladvapi32 -lshell32 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
